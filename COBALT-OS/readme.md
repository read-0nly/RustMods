...
- This is just the base mod - look at the COS-* folders for datatapes that integrate with this. Power station engineer also requires this mod (and powertransmission, though this doesn't require powertransission)
